...
- [x] 1. Implement size chart engine foundation
  - [x] 1.1 Create `src/utils/sizeChartEngine.ts` with interfaces and validation
  ...
  - [x] 1.2 Create `src/data/defaultSizeCharts.ts` with extracted default size chart data
  ...
  - [x] 1.3 Write property test: size chart validation correctness
  ...
  - [x] 1.4 Write property test: size chart serialization round-trip
  ...
  - [x] 1.5 Write unit tests for size chart engine edge cases
...
- [x] 2. Checkpoint — Size chart engine complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 3. Implement Blender garment baking pipeline
  - [x] 3.1 Create `scripts/bake-garments.py` with CLI argument parsing and body import
  ...
  - [x] 3.2 Implement parametric garment pattern creation in `scripts/bake-garments.py`
  ...
  - [x] 3.3 Implement cloth simulation and morph target baking in `scripts/bake-garments.py`
  ...
  - [x] 3.4 Implement GLB export in `scripts/bake-garments.py`
...
- [x] 4. Checkpoint — Blender pipeline complete
...
- [x] 5. Extend bodyStore and modify heatmapEngine for garment shell support
  - [x] 5.1 Add garment shell state to `src/stores/bodyStore.ts`
  ...
  - [x] 5.2 Add `sizeChartOverride` parameter to `computeHeatmap()` in `src/utils/heatmapEngine.ts`
...
- [x] 6. Implement GarmentShell runtime component
  - [x] 6.1 Create `src/components/GarmentShell.tsx` with GLB loading and morph sync
  ...
  - [x] 6.2 Implement garment material and heatmap rendering in `src/components/GarmentShell.tsx`
...
- [x] 7. Checkpoint — GarmentShell component complete
  - Ensure TypeScript compiles cleanly. Ask the user if questions arise.

- [x] 8. Integration — wire BodyModel, Scene, and heatmap transfer
  - [x] 8.1 Modify `src/components/BodyModel.tsx` for garment shell coordination
  ...
  - [x] 8.2 Modify `src/components/Scene.tsx` to include GarmentShell
  ...
  - [x]* 8.3 Write integration tests for size chart + heatmap flow
